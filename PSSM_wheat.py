    ...
    with open(feature_path + "\\pssm.txt", "w") as w:
        ...
        for fasta in fasta_sequences:
            ...
            with open(fasta_path + "\\temp.fa", "w") as out_file:
                out_file.write(">" + name + "\n" + sequence)
            psi_command = "PSI_blast\\bin\\psiblast " + " -query " + fasta_path + "\\temp.fa" + " -db " + Database_path + " -num_iterations " + "3" + " -out_ascii_pssm " + pssm_path + "\\{}.pssm".format(
                name)
